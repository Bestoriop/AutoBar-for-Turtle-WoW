...
AUTOBAR_CLASS_HEALING_SALVES = "치유 연고";
...
AUTOBAR_CLASS_HOURGLASS_SAND = "시간의 모래";
...
AUTOBAR_CLASS_FOOD_AP = "음식: 공격력 보너스";
AUTOBAR_CLASS_FOOD_ATKSPEED = "음식 : 공격 및 시전 속도";
...
AUTOBAR_CLASS_SLOWING_BOLAS = "둔화 볼라";
AUTOBAR_CLASS_NETS = "그물";
