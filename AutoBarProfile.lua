...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[BUFFSLOT] = { "POTIONS_FORTITUDE","POTIONS_AGILITY","POTIONS_STRENGTH","SCROLLS_AGILITY", "SCROLLS_PROTECTION", "SCROLLS_SPIRIT", "SCROLLS_STAMINA", "SCROLLS_STRENGTH", "JUJU_ATTACKPOWER", "JUJU_ATTACKSPEED", "JUJU_DODGE", "JUJU_FROST", "JUJU_FIRE", "SCROLLS_INTELLECT", "POTIONS_SPELLPOWER" };
	...
	AutoBarProfile.MAGE[BUFFSLOT] = { "POTIONS_FORTITUDE","SCROLLS_AGILITY", "SCROLLS_PROTECTION", "SCROLLS_SPIRIT", "SCROLLS_STAMINA", "SCROLLS_STRENGTH", "JUJU_ATTACKPOWER", "JUJU_ATTACKSPEED", "SCROLLS_INTELLECT", "POTIONS_SPELLPOWER" };
