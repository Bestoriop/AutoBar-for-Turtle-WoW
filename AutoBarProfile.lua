...
function AutoBarProfile.InitializeBasic()
	...
	AutoBarProfile.basic[4] = { "HEALING_POTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_ROOT", "HEALING_AND_MANA_NDB", "HEALING_POTIONS_R6", "HEALING_POTIONS_BG", "HEALTHSTONE" };
	AutoBarProfile.basic[POTIONSLOT] = Compost:GetTable();
	AutoBarProfile.basic[6] = { "PROTECTION_ARCANE", "PROTECTION_FROST", "PROTECTION_NATURE", "PROTECTION_SHADOW", "PROTECTION_FIRE" };
...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[POTIONSLOT] = { "POTION_NRJ" };
	...
	AutoBarProfile.ROGUE[BUFFSLOT] = { "POTIONS_FORTITUDE","POTIONS_AGILITY","POTIONS_STRENGTH","SCROLLS_AGILITY", "SCROLLS_PROTECTION", "SCROLLS_SPIRIT", "SCROLLS_STAMINA", "SCROLLS_STRENGTH", "BUFF_ATTACKPOWER", "BUFF_ATTACKSPEED", "BUFF_DODGE", "BUFF_FROST", "BUFF_FIRE", "SCROLLS_INTELLECT", "POTIONS_SPELLPOWER" };
	...
	AutoBarProfile.DRUID[POTIONSLOT] = { "MANA_RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_AND_MANA_NDB", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "" };
	AutoBarProfile.DRUID[BUFFSLOT1] = { "WATER", "WATER_CONJURED" };
	AutoBarProfile.DRUID[BUFFSLOT2] = { "WATER_SPIRIT" };
	AutoBarProfile.DRUID[FOODSLOT] = { "FOOD_STRENGTH", "FOOD_AGILITY", "FOOD_STAMINA", "MERLOTS_AND_RUMS", "FOOD_INTELLIGENCE", "FOOD_HPREGEN", "FOOD_MANAREGEN", "FOOD_SPELLPOWER" };
	AutoBarProfile.DRUID[BUFFSLOT] = AutoBarProfile.ROGUE[BUFFSLOT];
	AutoBarProfile.DRUID[WEAPONBUFFSLOT] = {"BS_SHARPENINGSTONES","BS_WEIGHTSTONE","ENCHANT_MANA_OILS","ENCHANT_WIZARD_OILS"};
	...
	AutoBarProfile.MAGE[POTIONSLOT] = { "MANA_RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_AND_MANA_NDB", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "MANA_STONES" };
	AutoBarProfile.MAGE[BUFFSLOT1] = AutoBarProfile.DRUID[BUFFSLOT1];
	AutoBarProfile.MAGE[BUFFSLOT2] = AutoBarProfile.DRUID[BUFFSLOT2];
	AutoBarProfile.MAGE[FOODSLOT] = { "FOOD_STAMINA", "MERLOTS_AND_RUMS", "FOOD_INTELLIGENCE", "FOOD_HPREGEN", "FOOD_MANAREGEN", "FOOD_SPELLPOWER", "FOOD_AGILITY" };
	AutoBarProfile.MAGE[BUFFSLOT] = { "POTIONS_FORTITUDE","SCROLLS_AGILITY", "SCROLLS_PROTECTION", "SCROLLS_SPIRIT", "SCROLLS_STAMINA", "SCROLLS_STRENGTH", "BUFF_ATTACKPOWER", "BUFF_ATTACKSPEED", "SCROLLS_INTELLECT", "POTIONS_SPELLPOWER" };
	AutoBarProfile.MAGE[WEAPONBUFFSLOT] = {"ENCHANT_MANA_OILS","ENCHANT_WIZARD_OILS"};
	...
	AutoBarProfile.PALADIN[WEAPONBUFFSLOT] = {"BS_SHARPENINGSTONES","BS_WEIGHTSTONE","ENCHANT_MANA_OILS","ENCHANT_WIZARD_OILS"};
