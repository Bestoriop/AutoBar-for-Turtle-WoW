...
function AutoBarProfile.InitializeBasic()
	...
	AutoBarProfile.basic[4] = { "HEALING_POTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_ROOT", "HEALING_SALVES", "NIGHT_DRAGONS_BREATH", "HEALING_POTIONS_R6", "HEALING_POTIONS_BG", "HEALTHSTONE" };
...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.DRUID[POTIONSLOT] = { "RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "NIGHT_DRAGONS_BREATH", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "TEAS" };
	...
	AutoBarProfile.MAGE[POTIONSLOT] = { "RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "NIGHT_DRAGONS_BREATH", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "MANASTONE", "TEAS" };
