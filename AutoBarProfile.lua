...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.MAGE[POTIONSLOT] = { "MANA_RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_AND_MANA_NDB", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "MANA_STONES", "HEALING_AND_MANA_TEAS" };
