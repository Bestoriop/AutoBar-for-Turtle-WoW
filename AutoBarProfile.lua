...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.DRUID[WEAPONBUFFSLOT] = {"BS_SHARPENINGSTONES","BS_WEIGHTSTONE","ENCHANT_MANA_OIL","ENCHANT_WIZARD_OIL"};
	...
	AutoBarProfile.MAGE[POTIONSLOT] = { "MANA_RUNES", "MANAPOTIONS", "HEALING_AND_MANA_POTIONS", "HEALING_AND_MANA_NDB", "MANAPOTIONS_R6", "MANAPOTIONS_BG", "MANASTONE", "HEALING_AND_MANA_TEAS" };
	...
	AutoBarProfile.MAGE[WEAPONBUFFSLOT] = {"ENCHANT_MANA_OIL","ENCHANT_WIZARD_OIL"};
	...
	AutoBarProfile.PALADIN[WEAPONBUFFSLOT] = {"BS_SHARPENINGSTONES","BS_WEIGHTSTONE","ENCHANT_MANA_OIL","ENCHANT_WIZARD_OIL"};
