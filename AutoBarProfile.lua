...
function AutoBarProfile.InitializeBasic()
	...
	AutoBarProfile.basic[4] = { "HEALING_POTIONS", "REJUVENATION_POTIONS", "WHIPPER_ROOT", "HEALING_SALVES", "NIGHT_DRAGONS_BREATH", "HEALING_POTIONS_R6", "HEALING_POTIONS_BG", "HEALTHSTONE" };
