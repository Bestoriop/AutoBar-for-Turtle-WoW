...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.DRUID[FOODSLOT] = { "FOOD_STRENGTH", "FOOD_AGILITY", "FOOD_STAMINA", "MERLOTS_AND_RUMS", "FOOD_INTELLIGENCE", "FOOD_HPREGEN", "FOOD_MANAREGEN" };
	...
	AutoBarProfile.MAGE[FOODSLOT] = { "FOOD_STAMINA", "MERLOTS_AND_RUMS", "FOOD_INTELLIGENCE", "FOOD_HPREGEN", "FOOD_MANAREGEN", "FOOD_AGILITY" };
