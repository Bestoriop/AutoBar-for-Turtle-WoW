...
AUTOBAR_CLASS_SCROLLOFAGILITY = "Scroll: Agility";
AUTOBAR_CLASS_SCROLLOFINTELLECT = "Scroll: Intellect";
AUTOBAR_CLASS_SCROLLOFPROTECTION = "Scroll: Protection";
AUTOBAR_CLASS_SCROLLOFSPIRIT = "Scroll: Spirit";
AUTOBAR_CLASS_SCROLLOFSTAMINA = "Scroll: Stamina";
AUTOBAR_CLASS_SCROLLOFSTRENGTH = "Scroll: Strength";
...
AUTOBAR_CLASS_ENERGYPOTIONS = "Potions: Energy";
AUTOBAR_CLASS_SWIFTNESSPOTIONS = "Potions: Swiftness";
