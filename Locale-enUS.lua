...
AUTOBAR_CLASS_UNGORORESTORE = "Crystal Restore";
...
AUTOBAR_CLASS_REJUVENATION_POTIONS = "Heal and Mana Potions";
...
AUTOBAR_CLASS_SWIFTNESSPOTIONS = "Potions: Speed";
