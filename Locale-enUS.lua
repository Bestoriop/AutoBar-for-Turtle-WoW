...
AUTOBAR_CLASS_ARROWS = "Ammos: Arrows";
AUTOBAR_CLASS_BULLETS = "Ammos: Bullets";

AUTOBAR_CLASS_ANTIVENOM = "Anti-Venom";
AUTOBAR_CLASS_BANDAGES = "Bandages";
AUTOBAR_CLASS_ALTERAC_BANDAGE = "Bandages: Alterac";
AUTOBAR_CLASS_WARSONG_BANDAGE = "Bandages: Warsong";
AUTOBAR_CLASS_ARATHI_BANDAGE = "Bandages: Arathi";

AUTOBAR_CLASS_BATTLESTANDARD = "Battle Standard";
AUTOBAR_CLASS_BATTLESTANDARDAV = "Battle Standard AV";

AUTOBAR_CLASS_MANA_OIL = "Enchantment Oils: Mana Regen";
AUTOBAR_CLASS_WIZARD_OIL = "Enchantment Oils: Damage/Healing Bonus";

AUTOBAR_CLASS_SHARPENINGSTONES = "BS : Sharpening stones";
...
AUTOBAR_CLASS_FOOD_AP = "Food: AP Bonus";
AUTOBAR_CLASS_FOOD_HASTE = "Food: Haste Bonus";
...
AUTOBAR_CLASS_HEALPOTIONS = "Healing Potions";
AUTOBAR_CLASS_PVP6HEALPOTIONS = "Healing Potions R6";
AUTOBAR_CLASS_HEALTHSTONE = "Healthstones";
AUTOBAR_CLASS_WHIPPER_ROOT = "Healing Whipper Root";
AUTOBAR_CLASS_HEALING_SALVES = "Healing Salves";
AUTOBAR_CLASS_BATTLEGROUNDHEALPOTIONS = "Healing Potions BG";
AUTOBAR_CLASS_UNGORORESTORE = "Healing Crystal Restore";
...
AUTOBAR_CLASS_BUFF_ATTACKPOWER = "Juju: Attack Power";
AUTOBAR_CLASS_BUFF_ATTACKSPEED = "Juju: Attack Speed";
AUTOBAR_CLASS_BUFF_DODGE = "Juju: Dodge";
...
AUTOBAR_CLASS_MANASTONE = "Mana Stones";
AUTOBAR_CLASS_BATTLEGROUNDMANAPOTIONS = "Mana Potions BG";
AUTOBAR_CLASS_DREAMLESS_SLEEP = "Mana : Dreamless Sleep";
AUTOBAR_CLASS_DEMONIC_DARK_RUNES = "Mana Runes: Demonic and Dark";

AUTOBAR_CLASS_MERLOTS_AND_RUMS = "Merlots and Rums: Stamina Bonus";	
	
AUTOBAR_CLASS_AGILITYPOTIONS = "Potions: Agility";
AUTOBAR_CLASS_STRENGTHPOTIONS = "Potions: Strength";
AUTOBAR_CLASS_FORTITUDEPOTIONS = "Potions: Fortitude";
AUTOBAR_CLASS_INTELLECTPOTIONS = "Potions: Intellect";
AUTOBAR_CLASS_SPELLPOWERPOTIONS = "Potions: Spell Power";
AUTOBAR_CLASS_DEFENSEPOTIONS = "Potions: Armor";
AUTOBAR_CLASS_TROLLBLOODPOTIONS = "Potions: HP5";
AUTOBAR_CLASS_FREE_ACTION_POTION = "Potions: LAP & FAP";
AUTOBAR_CLASS_RAGEPOTIONS = "Potions: Rage";
AUTOBAR_CLASS_ENERGYPOTIONS = "Potion: Energy";
AUTOBAR_CLASS_SWIFTNESSPOTIONS = "Potion: Swiftness";
...
AUTOBAR_CLASS_INVULNERABILITY_POTIONS = "Potion: Invulnerability";


AUTOBAR_CLASS_SCROLLOFAGILITY = "Scrolls: Agility";
AUTOBAR_CLASS_SCROLLOFINTELLECT = "Scrolls: Intellect";
AUTOBAR_CLASS_SCROLLOFPROTECTION = "Scrolls: Protection";
AUTOBAR_CLASS_SCROLLOFSPIRIT = "Scrolls: Spirit";
AUTOBAR_CLASS_SCROLLOFSTAMINA = "Scrolls: Stamina";
