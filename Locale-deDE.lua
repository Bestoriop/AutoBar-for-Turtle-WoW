...
AUTOBAR_CLASS_HEALING_SALVES = "Heilsalbe"
...
AUTOBAR_CLASS_HOURGLASS_SAND = "Stundenglassand";
...
AUTOBAR_CLASS_FOOD_AP = "Nahrung: Angriffskraft Bonus";
AUTOBAR_CLASS_FOOD_ATKSPEED = "Nahrung: Angriffs-und Zaubergeschwindigkeit";
...
AUTOBAR_CLASS_SLOWING_BOLAS = "verlangsamte Bolas";
AUTOBAR_CLASS_NETS = "Netze";
