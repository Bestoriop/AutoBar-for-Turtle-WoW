...
AUTOBAR_CLASS_HEALING_SALVES = "治疗药膏";
...
AUTOBAR_CLASS_HOURGLASS_SAND = "沙漏沙";
...
AUTOBAR_CLASS_FOOD_AP = "食物：攻击力加成";
AUTOBAR_CLASS_FOOD_ATKSPEED = "食物：攻击和施法速度";
...
AUTOBAR_CLASS_SLOWING_BOLAS = "减速波拉斯";
AUTOBAR_CLASS_NETS = "网";
